...
namespace Architecture
{
    ...
    public class FallingBuilding : MonoBehaviour
    {
        ...
        public void Init (Building building)
        {
            ...
            int tTop = m_building.GetData().spriteRowIndex * 8;
            int tLeft = m_building.m_spriteIndex * 8;
            float tWidth = m_building.GetData().size.x * 8;
            float tHeight = m_building.GetData().size.y * 8;
            ...
            GetComponent<BoxCollider2D>().size = m_building.GetData().size;
        }
