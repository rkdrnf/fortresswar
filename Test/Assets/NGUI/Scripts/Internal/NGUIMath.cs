...
static public class NGUIMath
{
    ...
    static public int AdjustByDPI(float height, int minHeight, int maxHeight)
    {
        float dpi = Screen.dpi;
        RuntimePlatform platform = Application.platform;
        ...
        else
        {
            ...
            float widthDifference = maxHeight - minHeight;
            int targetHeight = Mathf.RoundToInt(minHeight + (widthDifference * diagonalPercantege));
